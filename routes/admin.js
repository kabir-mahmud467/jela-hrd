...
router.get('/', requireAdmin, async (req, res, next) => {
  try {
    const [cImportant, cBook, cNote, cQuestion, cDars, cDua, cAyatHadith, cSurah, cBan] = await Promise.all([
    ...
    const [recentQ, recentB, recentN, recentDars, recentDua, recentAyat, recentSurah, recentImp, events24h] = await Promise.all([
    ...
    res.render('admin/dashboard', {
      ...
      counts: { important: cImportant, book: cBook, note: cNote, question: cQuestion, dars: cDars, dua: cDua, ayatHadith: cAyatHadith, surah: cSurah, ban: cBan },
      recent,
      topIps,
      events24h,
      sys
