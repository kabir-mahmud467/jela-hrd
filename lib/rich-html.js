 ...
 *   http(s) links only, everything else escaped or dropped. Script/style/
 *   iframe etc. dropped WITH their content.
...
(function (root, factory) {
  ...
  var ALLOWED = { p: 1, br: 1, strong: 1, em: 1, u: 1, s: 1, strike: 1, del: 1, h3: 1, ul: 1, ol: 1, li: 1, blockquote: 1, a: 1 };
  ...
  function decodeEntities(s) {
    return String(s).replace(/&(?:amp|lt|gt|quot|#39|#x27|#x22|#(\d+)|#x([0-9a-fA-F]+));/g,
      function (m, dec, hex) {
        if (dec) {
          try {
  ...
  function hasHtml(s) {
    return /<\/?(p|div|strong|b|em|i|u|s|strike|del|h3|ul|ol|li|blockquote|a|br)[\s>/]/i.test(String(s));
  }
